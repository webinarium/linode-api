...
use Linode\Entity;
use Linode\LinodeInstances\Repository\ConfigurationProfileRepository;
use Linode\LinodeInstances\Repository\DiskRepository;
use Linode\LinodeInstances\Repository\LinodeNetworkRepository;
use Linode\LinodeInstances\Repository\LinodeVolumeRepository;
 ...
 * @property LinodeBackups                           $backups          Information about this Linode's backups status.
 * @property ConfigurationProfileRepositoryInterface $configs          Configuration profiles.
 * @property DiskRepositoryInterface                 $disks            Disks.
 * @property LinodeNetworkRepositoryInterface        $ips              Network information.
 * @property LinodeVolumeRepositoryInterface         $volumes          Volumes.
 */
