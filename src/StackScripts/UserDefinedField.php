 ...
 *
 * @property string $label   A human-readable label for the field that will serve as the input
 ...
 * @property string $manyOf  A list of acceptable values for the field in any quantity,
