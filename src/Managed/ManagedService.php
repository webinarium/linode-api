...
/**
 * A service that Linode is monitoring as part of your Managed services. If issues
 * are detected with this service, a ManagedIssue will be opened and, optionally,
 * Linode special forces will attempt to resolve the Issue.
 *
 ...
 *                                           down.
 * @property null|string $body               What to expect to find in the response body for the Service to be considered up.
 * @property null|string $notes              Any information relevant to the Service that Linode special forces should know
 *                                           when attempting to resolve Issues.
 * @property string      $region             The Region in which this Service is located. This is required if address is a
 *                                           private IP, and may not be set otherwise.
 * @property int[]       $credentials        An array of ManagedCredential IDs that should be used when attempting to resolve
