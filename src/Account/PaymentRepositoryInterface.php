...
interface PaymentRepositoryInterface extends RepositoryInterface
{
    ...
    /**
     * This begins the process of submitting a Payment via PayPal. After calling this
     * endpoint, you must take the resulting `payment_id` along with the `payer_id` from
     * your PayPal account and POST /account/payments/paypal-execute to complete the
     * Payment.
     *
     ...
     * authorization process - this endpoint executes the Payment to capture the funds
     * and credit your Linode Account.
     *
